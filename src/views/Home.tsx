    ...
    <Layout title="DailyHot API">
      <main className="home">
        ...
        <div className="title">
          ...
          <span className="title-tip">大众热点版已上线，当前仅保留 16 个高频热点源</span>
        </div>
        <div class="control">
          <button id="all-button">
            ...
            <span className="btn-text">大众热点接口</span>
          </button>
          <button id="docs-button">
            ...
            <span className="btn-text">API 文档</span>
          </button>
        </div>
        <section className="route-grid home-route-grid">
